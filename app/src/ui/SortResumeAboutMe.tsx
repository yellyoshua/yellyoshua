...
export function SortResumeAboutMe() {
  ...
  const renderQuickActions = () => {
    return <div className="pt-5">
      <h1 className="font-arvo text-xl font-bold text-black dark:text-white">Acciones r&aacute;pidas</h1>
      <DarkModeSwitch />
    </div>
  }

  return <div className="md:h-screen mb-16 md:mb-0">
    <div className="grid grid-flow-row sm:grid-cols-1 md:grid-cols-2 select-none">
      ...
      <div className="flex m-auto pt-5 md:pt-0 md:m-0 place-items-center">
        <div className="text-left md:w-7/12 w-60">
          ...
          <h2 className="font-arvo text-lg text-black dark:text-white">Un joven autodidacta apasionado por el aprender constantemente cada d&iacute;a.</h2>
          {renderQuickActions()}
        </div>
      </div>
    </div>
