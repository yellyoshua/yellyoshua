...
export const COPYRIGHT: string = "Copyright 2021 Yoshua López. All Rights Reserved."
...
export const PROJECTS: Project[] = [
  {
    ...
    name: "Whatsapp Book",
    description: "It's an app that parse the whatsapp chat and export converted chat as PDF, JSON or HTML.",
    projectPath: "/whatsapp-book",
    development: false,
  ...
  },
  {
    ...
    name: "Elections App",
    description: "It's an app for elections electoral. In construction with the blockchain tecnology.",
    projectPath: "/elections-app",
    development: true,
    isExternalLink: false,
  },
  {
